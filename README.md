...
For example, here's how a [simple for comprehension is encoded in 3.3.7](https://github.com/keynmol/scala-bytecode-showcase/blob/main/snapshots/3.3.7/for_definitions_decompiled), and here's how [it was dramatically simplified compared to 3.8.2](https://github.com/keynmol/scala-bytecode-showcase/blob/main/snapshots/3.3.7_3.8.2_decompiled.diff#L980-L1005) thanks [Better fors SIP](https://www.scala-lang.org/api/current/docs/other-new-features/better-fors.html).
